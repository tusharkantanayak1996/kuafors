            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <a href="{{ url('admin/add-question') }}" style="float:right"><button
                                    class="btn btn-primary shadow-md mr-2">Add Question
                                </button>
                            </a>
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td class="text-center">{{ ucfirst($data->category) }}</td>
                                    <td class="text-center">{{ ucfirst($data->questions) }}</td>
                                    <td class="text-center">
                                        <a href="{{ url('admin/edit-question', $data->id) }}" class="btn btn-outline-info"><svg
                                        ...
                                        <a href="/admin/question/{{ @$data->id }}/delete" class="btn btn-outline-danger"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="20px" height="20px"
