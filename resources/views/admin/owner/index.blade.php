                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" placeholder="Search now..." class="form-control" id="search_data"
                                        name="search">
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table">
                        <thead class="bg-white">
                            <tr>
                                ...
                                <th class="text-center">Has Subscription</th>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('admin/edit-owner', $data->id) }}" class="btn btn-outline-info"><svg
                                        ...
                                        <a href="{{ url('admin/delete-owner', $data->id) }}" class="btn btn-outline-danger"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="20px" height="20px"
                                        ...
                                        @if ($data->status == 'enable')
                                            <a href="{{ url('admin/disable-owner', $data->id) }}"
                                                class="btn btn-light">Disable</a>
                                        @else
                                            <a href="{{ url('admin/enable-owner', $data->id) }}"
                                                class="btn btn-light">Enable</a>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                                @if ($data->has_subscription == 'Yes')
                                                    <!-- <a href="{{ url('admin/changesubscription', $data->id) }}"
                                                        class="btn btn-light">Yes</a> -->
                                                        <a href=""
                                                        class="btn btn-light">Yes</a>
                                                @else
                                                    <!-- <a href="{{ url('admin/enable-owner', $data->id) }}"
                                                        class="btn btn-light">No</a> -->
                                                        <a href=""
                                                        class="btn btn-light">No</a>
                                                @endif
                                    </td>
