            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <a href="{{ url('admin/add-coupon') }}" style="float:right"><button
                                    class="btn btn-primary shadow-md mr-2">Add New Coupon
                                </button>
                            </a>
                        </div>
                    </div>
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($coupon as $data)
                                <tr>
                                    <input name="coupon_code" type="hidden" class="coupon_del" value="{{ $data->id }}">
                                    <td class="text-center">{{ $data->id }}</td>
                                    <td class="text-center">{{ $data->coupon_code }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('admin/edit-coupon', $data->id) }}"
                                            class="btn btn-outline-info"><svg xmlns="http://www.w3.org/2000/svg"
                                                width="20px" height="20px" viewBox="0 0 1101.688 979.443">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.show_confirm').click(function(e) {
                e.preventDefault();
                var delete_id = $(this).closest("tr").find('.coupon_del').val();
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                type: "get",
                                url: '/admin/delete-coupon/' + delete_id,
                                data: data,
