                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                                ...
                                @foreach ($cancelledowners as $plan)
                                <tr>
                                    <td class="text-center">{{ $plan->users->business_name }}</td>
                                    <td class="text-center">Owner</td>
                                    <td class="text-center">{{ @$plan->ownerplan->name }}</td>
                                    <td class="text-center">{{ @$plan->ownerplan->type }}</td>
                                    <td class="text-center">{{ $plan->start_date }}</td>
                                    <td class="text-center">{{ $plan->end_date }}</td>
                                    <!-- <td class="text-center">
                                        <a href="{{ url('admin/edit-ownerplan', $plan->id) }}" class="btn btn-outline-info"><svg
                                        ...
                                        <a href="{{ url('admin/delete-ownerplan', $plan->id) }}"
                                ...
                                @foreach ($cancelledtechnicians as $plan)
                                <tr>
                                    <td class="text-center">{{ $plan->users->business_name }}</td>
                                    <td class="text-center">Technician</td>
                                    <td class="text-center">{{ @$plan->technicianplan->name }}</td>
                                    <td class="text-center">{{ @$plan->technicianplan->type }}</td>
                                    <td class="text-center">{{ $plan->start_date }}</td>
                                    <td class="text-center">{{ $plan->end_date }}</td>
                                    <!-- <td class="text-center">
                                        <a href="{{ url('admin/edit-ownerplan', $plan->id) }}" class="btn btn-outline-info"><svg
